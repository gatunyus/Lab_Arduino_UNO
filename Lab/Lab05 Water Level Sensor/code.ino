...
## Overview (ภาพรวม)
โปรเจกต์นี้เป็นการทดลองใช้งาน <font color="#0077B6">**Water Sensor (เซ็นเซอร์วัดระดับน้ำ / ความชื้น)**</font> เซ็นเซอร์ชนิดนี้ทำงานโดยอาศัยหลักการนำไฟฟ้าของน้ำ เมื่อมีหยดน้ำหรือความชื้นมาสัมผัสกับลายวงจรบนแผ่นเซ็นเซอร์ จะทำให้ค่าความต้านทานเปลี่ยนไป 
...
## Code
อัปโหลดโค้ดด้านล่างนี้ลงในบอร์ด Arduino (เปิด Serial Monitor และตั้งค่า Baud Rate เป็น `9600`):
