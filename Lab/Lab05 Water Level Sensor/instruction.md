...
## Overview (ภาพรวม)
แลปเจกต์นี้เป็นการทดลองใช้งาน <font color="#E63946">**Water Sensor (เซ็นเซอร์วัดระดับน้ำ / ความชื้น)**</font> เซ็นเซอร์ชนิดนี้ทำงานโดยอาศัยหลักการนำไฟฟ้าของน้ำ เมื่อมีหยดน้ำหรือความชื้นมาสัมผัสกับลายวงจรบนแผ่นเซ็นเซอร์ จะทำให้ค่าความต้านทานเปลี่ยนไป 
