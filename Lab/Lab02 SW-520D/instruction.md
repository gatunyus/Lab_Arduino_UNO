...
## Overview (ภาพรวม)
โปรเจกต์นี้เป็นการทดลองใช้งาน **Tilt Sensor (เซ็นเซอร์วัดการเอียง)** เซ็นเซอร์ตัวนี้ทำงานคล้ายกับสวิตช์ที่จะเปิด/ปิดวงจรตามองศาการเอียงของตัวเซ็นเซอร์ (มักใช้ปรอทหรือลูกกลิ้งโลหะด้านใน) 
