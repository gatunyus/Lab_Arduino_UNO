...
## Overview (ภาพรวม)
แลปนี้เป็นการทดลองใช้งาน <font color="#E63946">**Sound Sensor (เซ็นเซอร์ตรวจจับเสียง)**</font> แบบอนาล็อก โมดูลนี้จะรับคลื่นเสียงผ่านไมโครโฟนและแปลงเป็นระดับแรงดันไฟฟ้า 
