...
## Overview (ภาพรวม)
แลปนี้เป็นการใช้บอร์ด Arduino ร่วมกับ **Vibration Sensor (เซ็นเซอร์ตรวจจับการสั่นสะเทือน)**เพื่ออ่านค่าสถานะการสั่นแบบดิจิทัล (Digital Read) เมื่อเซ็นเซอร์ตรวจพบแรงสั่นสะเทือน บอร์ดจะแสดงผลลัพธ์การทำงานผ่านทาง Serial Monitor ทันที แลปนี้เหมาะสำหรับเป็นพื้นฐานในการนำไปประยุกต์ใช้กับระบบสัญญาณกันขโมย หรือระบบตรวจจับการสั่นของเครื่องจักร
